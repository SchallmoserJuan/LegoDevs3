...
Aplicación frontend desarrollada como trabajo práctico para la materia Frontend (IFTS 29). Es una SPA construida con React + Vite que incorpora navegación con Sidebar, temas claro/oscuro, páginas de datos (JSON y API), Bitácora, Perfil con módulos, y una sección de Diagramas.
